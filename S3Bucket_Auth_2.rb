CloudFormation do
  Description("AWS CloudFormation Sample Template S3Bucket_Auth_2: Simple test template showing how to get a file from a private S3 bucket onto an EC2 instance using authenticated GetObject requests. In this template the credentials to use to authenticate for the S3 bucket are defined in the files section. **WARNING** This template creates an Amazon EC2 instance. You will be billed for the AWS resources used if you create a stack from this template.")
