CloudFormation do
  ...
  Output("AZ1") do
    ...
    Value(FnGetAtt("ProducerConsumer1", "AvailabilityZone"))
  end

  Output("PublicIP1") do
    Description("Public IP address of the newly created EC2 instance (1)")
    Value(FnGetAtt("ProducerConsumer1", "PublicIp"))
  end

  Output("PrivateIP1") do
    Description("Private IP address of the newly created EC2 instance (1)")
    Value(FnGetAtt("ProducerConsumer1", "PrivateIp"))
  end

  Output("InstanceId2") do
  ...
  Output("AZ2") do
    ...
    Value(FnGetAtt("ProducerConsumer2", "AvailabilityZone"))
  end

  Output("PublicIP2") do
    Description("Public IP address of the newly created EC2 instance (2)")
    Value(FnGetAtt("ProducerConsumer2", "PublicIp"))
  end

  Output("PrivateIP2") do
    Description("Private IP address of the newly created EC2 instance (2)")
    Value(FnGetAtt("ProducerConsumer2", "PrivateIp"))
  end
end
