CloudFormation do
  ...
  Resource("ElasticLoadBalancer") do
    ...
    Metadata("Comment2", "Use install path for healthcheck to avoid redirects - ELB healthcheck does not handle 302 return codes")
  ...
  Resource("WebServerSecurityGroup") do
    ...
    Property("GroupDescription", "Enable HTTP access via port 80 locked down to the load balancer + SSH access")
