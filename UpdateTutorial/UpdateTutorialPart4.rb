CloudFormation do
  Description("AWS CloudFormation Sample Template UpdateTutorial Part 4: Sample template that can be used to test EC2 updates. **WARNING** This template creates an Amazon Ec2 Instance. You will be billed for the AWS resources used if you create a stack from this template.")
  AWSTemplateFormatVersion("2010-09-09")

  Parameter("WebServerKeyName") do
  ...
  Resource("WebServerSecurityGroup") do
    ...
    Property("GroupDescription", "Enable HTTP and SSH")
  ...
  Ref("WebServerSecurityGroup")
    ...
    Property("KeyName", Ref("WebServerKeyName"))
